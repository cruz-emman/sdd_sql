...
const mysql2 = require('mysql2/promise');
 ...
 const addQuestion4 = async (req, res) => {
    ...
    const query = `INSERT INTO employeesquestionpart4 (question, question_order, type,toggle) VALUES (?,?,?,?)`;
 ...
 const getQuestion4 = async (req,res) =>{
    const query = "SELECT * FROM employeesquestionpart4"
 ...
 const getSingleQuestion4 = async (req,res ) =>{
  ...
  const query = "SELECT * FROM employeesquestionpart4 WHERE idemployeesquestionpart4 = ?"
 ...
 const updateQuestion4 = async (req,res) =>{
  const id = req.params.id;
  const q = "UPDATE employeesquestionpart4 SET `question`=?, `question_order` = ?, `type` = ?, `toggle`=? WHERE `idemployeesquestionpart4` = ?"
 ...
 const deleteQuestion4 = async (req,res) =>{
  const id = req.params.id;
  const q = "DELETE FROM employeesquestionpart4 WHERE `idemployeesquestionpart4` = ? "
...
const getQuestionType4 = async (req,res ) =>{
  ...
  const query = "SELECT * FROM employeesquestionpart4 WHERE question_order = ?"
  const id = req.params.id
  try {
    const conn = await mysql2.createConnection({
      host: 'localhost',
