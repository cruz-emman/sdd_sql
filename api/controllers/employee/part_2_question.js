...
const mysql2 = require('mysql2/promise');
 ...
 const addQuestion2 = async (req, res) => {
    ...
    const query = `INSERT INTO employeesquestionpart2 (question, question_order, type,toggle) VALUES (?,?,?,?)`;
 ...
 const getQuestion2 = async (req,res) =>{
    const query = "SELECT * FROM employeesquestionpart2"
 ...
 const getSingleQuestion2 = async (req,res ) =>{
  ...
  const query = "SELECT * FROM employeesquestionpart2 WHERE idemployeesquestionpart2 = ?"
 ...
 const updateQuestion2 = async (req,res) =>{
  const id = req.params.id;
  const q = "UPDATE employeesquestionpart2 SET `question`=?, `question_order` = ?, `type` = ?, `toggle`=? WHERE `idemployeesquestionpart2` = ?"
 ...
 const deleteQuestion2 = async (req,res) =>{
  const id = req.params.id;
  const q = "DELETE FROM employeesquestionpart2 WHERE `idemployeesquestionpart2` = ? "
...
const getQuestionType2 = async (req,res ) =>{
  ...
  const query = "SELECT * FROM employeesquestionpart2 WHERE question_order = ?"
  const id = req.params.id
  try {
    const conn = await mysql2.createConnection({
      host: 'localhost',
