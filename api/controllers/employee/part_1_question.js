...
const mysql2 = require('mysql2/promise');
 ...
 const addQuestion1 = async (req, res) => {
    ...
    const query = `INSERT INTO employeesquestionpart1 (question, question_order, type,toggle) VALUES (?,?,?,?)`;
 ...
 const getSingleQuestion1 = async (req,res ) =>{
  ...
  const query = "SELECT * FROM employeesquestionpart1 WHERE idemployeesquestionpart1 = ?"
 ...
 const updateQuestion1 = async (req,res) =>{
  const id = req.params.id;
  const q = "UPDATE employeesquestionpart1 SET `question`=?, `question_order` = ?, `type` = ?, `toggle`=? WHERE `idemployeesquestionpart1` = ?"
 ...
 const deleteQuestion1 = async (req,res) =>{
  const id = req.params.id;
  const q = "DELETE FROM employeesquestionpart1 WHERE `idemployeesquestionpart1` = ? "
...
const getQuestionNumber = async (req,res) =>{
  const query = "SELECT * FROM employeesquestionpart1 WHERE question_order = ?"
  const id = req.params.id
  try {
    const conn = await mysql2.createConnection({
      host: 'localhost',
...
module.exports = {addQuestion1, getQuestion1, getSingleQuestion1 , updateQuestion1 ,deleteQuestion1, getQuestionNumber , getQuestionType}