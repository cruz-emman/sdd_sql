...
const mysql2 = require('mysql2/promise');
 ...
 const addQuestion3 = async (req, res) => {
    ...
    const query = `INSERT INTO studentsquestionpart3 (question, question_order, type,toggle) VALUES (?,?,?,?)`;
 ...
 const getQuestion3 = async (req,res) =>{
    const query = "SELECT * FROM studentsquestionpart3"
 ...
 const getSingleQuestion3 = async (req,res ) =>{
  ...
  const query = "SELECT * FROM studentsquestionpart3 WHERE idstudentsquestionpart3 = ?"
 ...
 const updateQuestion3 = async (req,res) =>{
  const id = req.params.id;
  const q = "UPDATE studentsquestionpart3 SET `question`=?, `question_order` = ?, `type` = ?, `toggle`=? WHERE `idstudentsquestionpart3` = ?"
 ...
 const deleteQuestion3 = async (req,res) =>{
  const id = req.params.id;
  const q = "DELETE FROM studentsquestionpart3 WHERE `idstudentsquestionpart3` = ? ";
...
const getQuestionType3 = async (req,res ) =>{
  ...
  const query = "SELECT * FROM studentsquestionpart3 WHERE question_order = ?"
  const id = req.params.id
  try {
    const conn = await mysql2.createConnection({
      host: 'localhost',
